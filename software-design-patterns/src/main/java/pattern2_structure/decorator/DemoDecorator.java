package pattern2_structure.decorator;

import pattern2_structure.decorator.demo.IClass;
import pattern2_structure.decorator.demo.IClassDecorator;
import pattern2_structure.decorator.demo.SubClassA;
import pattern2_structure.decorator.wrapper.ForwardingSet;
import pattern2_structure.decorator.wrapper.InstrumentedSet;
